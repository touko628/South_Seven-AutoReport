...
class Report(object):
    ...
    def report(self):
        ...
        if (is_new_upload == 1):
            ...
            print(session.post("https://weixine.ustc.edu.cn/2020/upload/1/delete", headers=header).text)
            print(session.post("https://weixine.ustc.edu.cn/2020/upload/2/delete", headers=header).text)
